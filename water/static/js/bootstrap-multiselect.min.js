!function (t, e) {
    ...
    void 0 !== e && e.bindingHandlers && !e.bindingHandlers.multiselect && (e.bindingHandlers.multiselect = {
        after: ["options", "value", "selectedOptions", "enable", "disable"], init: function (i, s, l, o, n) {
            var a = t(i), p = e.toJS(s());
            ...
            if (l.has("enable")) {
                ...
                }).extend({rateLimit: 100, notifyWhenChangesStop: !0}) : u(d)
            }
            if (l.has("disable")) {
                var b = l.get("disable");
                ...
                }).extend({rateLimit: 100, notifyWhenChangesStop: !0}) : u(!b)
            }
        ...
        defaults: {
            ...
            this.$select.children().each(t.proxy(function (e, i) {
                ...
                e.stopPropagation();
                var i = t(e.target).prop("checked") || !1, s = t(e.target).closest("li"),
                ...
                this.options.selectedClass && (i ? s.addClass(this.options.selectedClass) : s.removeClass(this.options.selectedClass)), t.each(l, t.proxy(function (e, s) {
                    var l = t(s).val(), n = this.getOptionByValue(l);
            ...
            var h = t("<input/>").attr("type", n), c = this.options.checkboxName(i);
                    ...
                    this.$ul.prepend(this.$filter), this.$filter.val(this.query).on("click", function (t) {
                        ...
                        13 === e.which && e.preventDefault(), clearTimeout(this.searchTimeout), this.searchTimeout = this.asyncFunction(t.proxy(function () {
                            ...
                            this.query !== e.target.value && (this.query = e.target.value, t.each(t("li", this.$ul), t.proxy(function (e, l) {
                                var o = t("input", l).length > 0 ? t("input", l).val() : "", n = t("label", l).text(),
                                    a = "";
            ...
            var e = t("li.multiselect-group", this.$ul), i = this.options.selectedClass;
            e.each(function () {
